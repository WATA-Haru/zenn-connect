...
以下に`%s/my-gitconfig/ThisIsSampleText/g`を打ち込んで、画像の8行目にある`7.my-gitconfig`を`7.ThisIsSampleText`に置換する例を示します。
...
画像の8行目`7.my-gitconfig`が`7.ThisIsSampleText`に置換されたことが分かります。
